...
class ROCrate():
    ...
    def find_root_entity_id(self, entities):
        ...
        # Uh oh..
        raise KeyError(
            "Can't find Root Data Entity in RO-Crate, see https://w3id.org/ro/crate/1.0#core-metadata-for-the-root-data-entity")
    ...
    def build_crate(self, entities, source, load_preview):
        ...
        prebuilt_entities = [root_id, metadata_id,
                             'ro-crate-preview.html']  # also, filter out the entity with id= ro-crate-metadata.jsonld   and the root dataset: can assume id='./' or '.'
